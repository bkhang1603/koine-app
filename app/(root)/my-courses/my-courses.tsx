...
//   let myCourses: GetMyCoursesResType["data"] = [];

//   if (myCoursesData && !myCoursesError) {
//     if (myCoursesData.data.length === 0) {
//       console.log("No courses found in coursesData");
//     } else {
//       const parsedResult = myCourseRes.safeParse(myCoursesData);
//       if (parsedResult.success) {
//         myCourses = parsedResult.data.data;
//       } else {
//         console.error("Validation errors:", parsedResult.error.errors);
//       }
//     }

//   if (myCoursesLoading) return <ActivityIndicatorScreen />;
//   if (myCoursesError) return <ErrorScreen message="Failed to load courses" />;
...
//               onPress={() =>
//                 router.push({
//                   pathname: "/learn/course/[courseId]",
//                   params: {
//                     courseId: course.id,
//                   },
//                 } as any)
...
//               />
//               <View className="p-4">
//                 <Text className="font-bold text-lg mb-2">{course.title}</Text>
...
//                     Tiến độ: {course.completionRate || 0}%
//                   </Text>
