        ...
        >
          <View className="flex-row items-center justify-between">
            <View className="flex-row items-center">
              <Pressable
                onPress={() => router.push("/(root)/sub-accounts/sub-accounts")}
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className="p-4 mt-4 mx-4 items-center border-b border-gray-100 bg-white rounded-xl shadow-sm">
          ...
          <View className="flex-row px-2 my-4">
            ...
            >
              <MaterialIcons name="school" size={20} color="#fff" />
              <Text className="text-white font-medium ml-2">Gán khóa học</Text>
            </Pressable>
            <Pressable
              className="bg-gray-100 p-2 mx-2 rounded-xl flex-row items-center justify-center px-4"
              onPress={() =>
            ...
            >
              <MaterialIcons name="edit" size={20} color="#374151" />
              <Text className="text-gray-700 font-medium ml-2">Chỉnh sửa</Text>
            </Pressable>
          </View>
        </View>
              ...
              <View className="flex-row">
                ...
                <View className="ml-3 flex-1">
                  ...
                  <View className="flex-row items-center my-2">
                    ...
                    <Text className="text-gray-600 ml-1 mr-1">
