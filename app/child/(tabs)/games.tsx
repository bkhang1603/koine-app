...
export default function GamesScreen() {
  ...
  const renderIcon = (game: Game) => {
    switch (game.iconType) {
      ...
      case "ionicons":
        return <Ionicons name={game.icon as any} size={32} color="white" />;
      default:
        return (
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className="px-4 pt-4 pb-8 bg-violet-500">
          <View className="flex-row items-center justify-between">
            <View>
              <Text className="text-white text-xl font-bold">Trò chơi</Text>
              <Text className="text-white/80 mt-1">Học thông qua trò chơi</Text>
            </View>
        ...
        <View className="bg-gray-50 rounded-t-3xl -mt-4 flex-1 pt-6">
          ...
          <View className="px-5 pt-6 pb-20">
            <View className="flex-row items-center justify-between mb-4">
              <Text className="text-xl font-bold">Trò chơi phổ biến</Text>
              {/* <Pressable
                                onPress={() => {
                        ...
                        <View className="flex-row items-center mb-1">
                          <View className="bg-violet-50 px-2 py-0.5 rounded-md">
                            <Text className="text-violet-700 text-xs font-medium">
                              {game.type.charAt(0).toUpperCase() +
                                game.type.slice(1)}
                            </Text>
                          </View>
                        </View>
