      ...
      items: [
        {
          ...
          value: "person",
          onValueChange: () => {
            console.log("Thông tin cá nhân setting");
            // router.push("/child/profile/edit")
          },
        },
        {
          id: "password",
          ...
          value: "lock",
          onValueChange: () => {
            console.log("Đổi mật khẩu setting");
            // router.push("/child/profile/change-password")
          },
        },
      ],
    },
      ...
      items: [
        {
          ...
          value: "help",
          onValueChange: () => {
            console.log("help setting child");
        ...
        },
        {
          ...
          value: "info",
          onValueChange: () => {
            console.log("child about setting");
            // router.push("/child/about")
          },
        },
      ],
    },
