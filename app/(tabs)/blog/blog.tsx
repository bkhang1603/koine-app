      ...
      <SafeAreaView>
            ...
            >
              ...
              <View className="p-4">
                ...
                <View className="flex-row items-center mt-3">
                  ...
                  <Text className="text-gray-400 mx-2">•</Text>
                  <Text className="text-gray-500">{featuredPost.date}</Text>
                </View>
              </View>
            </Pressable>
          </View>
        ...
        <View className="p-4">
          ...
          {recentPosts.map((post) => (
            ...
            >
              <Image source={{ uri: post.thumbnail }} className="w-24 h-24" />
              <View className="flex-1 p-3">
                <View className="flex-row items-center">
                  ...
                  <Text className="text-gray-400 mx-2">•</Text>
                  <Text className="text-gray-500 text-xs">{post.readTime}</Text>
                </View>
