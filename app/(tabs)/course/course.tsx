        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View className="flex-1 items-center justify-center p-8">
            ...
            <Pressable
              ...
              onPress={() => router.push("/search/searchCourse")}
            >
              <Text className="text-white font-medium">Tìm khóa học</Text>
            </Pressable>
          </View>
        </ScrollView>
      </View>
    ...
    <View className="flex-1 bg-[#f5f7f9]">
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <View>
                ...
                <View className="p-5">
                  ...
                  <View className="flex-row justify-between items-center">
                    ...
                    <Pressable
                      className="bg-blue-500 rounded-full py-2.5 px-5 flex-row justify-center items-center"
                      onPress={() =>
                        router.push({
                          pathname: "/courses/[id]",
                          params: { id: courses[0].id },
        ...
        <View className="p-5 mb-20">
          <Text className="text-lg font-bold mb-3">Tạo khóa học riêng</Text>
          <LinearGradient
            ...
            >
              <View className="relative">
                ...
                <Text className="text-white/80 mb-4 w-3/4">
                  Thiết kế khóa học phù hợp với nhu cầu học tập của bạn
                </Text>

                <View className="flex-row">
                  <Pressable className="bg-white/20 px-4 py-2 rounded-lg">
                    <Text className="text-white font-medium">Tạo ngay</Text>
                  </Pressable>
                </View>
              </View>
            </Pressable>
