          ...
          <View className="flex-row items-center justify-between mb-6">
            <View className="flex-row items-center">
              <View className="w-12 h-12 rounded-full bg-white/20 items-center justify-center mr-3">
                <Image
                  source={{
                    uri: profileData?.data.avatarUrl,
                  }}
              ...
              <View className="relative">
                ...
                <View className="pr-10">
                  ...
                  <Text className="text-white/80 text-sm mb-4 leading-5">
                    Thiết kế khóa học theo nhu cầu riêng và mục tiêu học tập của
                    bạn
                  </Text>
        ...
        <View className="mt-8">
          <View className="px-5 flex-row items-center justify-between mb-4">
            ...
            <Pressable
              ...
              disabled={!featuredCourses || featuredCourses.length === 0}
            >
                ...
                >
                  ...
                  <View className="px-4 py-2">
                    ...
                    <View className="mt-3 pt-3 border-t border-gray-100 flex-row items-center justify-between">
                      ...
                      <Pressable
                        className="w-8 h-8 rounded-full bg-blue-500 items-center justify-center shadow-sm"
                        onPress={() => {
                          const productDetail = JSON.stringify(product);
                          router.push({
                            pathname: "/product/[id]",
